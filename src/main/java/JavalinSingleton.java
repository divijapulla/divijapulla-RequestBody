...
public class JavalinSingleton {
    ...
    public static Javalin getInstance(){
        ...
        app.post("/echo", ctx -> {
            ...
            String jsonString = ctx.body(); // Get JSON from request body
            Song song = om.readValue(jsonString, Song.class); // Convert to Song object
            ctx.json(song);
        ...
        app.post("/changeartisttobeatles", ctx -> {
            ...
            String jsonString = ctx.body(); // Get JSON from request body
            Song song = om.readValue(jsonString, Song.class); // Convert to Song object
            song.setArtistName("Beatles"); // Modify artistName
            ctx.json(song);
